...
var modified = require('./checktime');
...
XdkClient.prototype.sendDirectory = function(dir, rebuildForce, cb) {
  var self = this;
  fs.lstat(dir, function(err, stats) {
    ...
    var modulesFolder = path.join(dir, 'node_modules');
    var channel = 'sync';
    if (rebuildForce) {
      channel = 'clean';
    } else if (fs.existsSync(modulesFolder) && modified.test(modulesFolder) ) {
      channel = 'clean';
    }
